...
Neste capítulo vamos aprimorar nosso projeto de forma a incluir diversidade de visualizações e interatividade.

## Um olho no Sol e outro na Terra

Até agora não mexemos na posição da câmera. Ela permaneceu fixa no sistema uma `a-entity` a parte, fora do sistema de referência do Sol. Mas podemos colocar a câmera onde quisermos, inclusive fixa na superfície da Terra. Para isso, basta colocarmos a câmera dentro da `a-entity terra`:
...
```
Essa posição da câmera produz a visualização o efeito mostrado no vídeo abaixo.
...
4. O código abaixo foi extraído de @silva2016. Salve-o em um arquivo HTML e carregue no seu navegador de internet para ver o resultado.
...
## Disponibilizando páginas web diretamente na Internet com Glitch
...
9. Agora, antes de começar a editar e trabalhar em projetos no Glitch, é importante [criar uma conta](https://glitch.com/signin) nele, pois isso permitirá acessar os projetos posteriormente.

10. Após criar a conta, acesse novamente a edição do projeto [fishy-foil-technosaurus](https://glitch.com/edit/#!/fishy-foil-technosaurus) e clique no botão *Remix do Edit* localizado no canto superior direito.

::: {.callout-note title="Tarefa"}
11. A partir do *fishy-foil-technosaurus* remixado, implemente o botão contador de clicadas que fizemos anteriormente no editor de texto.
:::
