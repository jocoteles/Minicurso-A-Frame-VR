...
8. Agora, antes de começar a editar e trabalhar em projetos no Glitch, é importante [criar uma conta](https://glitch.com/signin) nele, pois isso permitirá acessar os projetos posteriormente.

9. Após criar a conta acesse novamente a edição do projeto [fishy-foil-technosaurus](https://glitch.com/edit/#!/fishy-foil-technosaurus) e clique no botão *Remix do Edit* localizado no canto superior direito.

::: {.callout-note title="Tarefa"}
10. A partir do *fishy-foil-technosaurus* remixado implemente o botão contador de clicadas que fizemos anteriormente no editor de texto.
:::
...
- A página web final (*Live site*): [https://fishy-foil-technosaurus.glitch.me](https://fishy-foil-technosaurus.glitch.me)
- A edição do código [*Code*]: [https://glitch.com/edit/#!/fishy-foil-technosaurus](https://glitch.com/edit/#!/fishy-foil-technosaurus) 
- Página de apresentação [*Project Page*]: [https://glitch.com/~fishy-foil-technosaurus](https://glitch.com/~fishy-foil-technosaurus)


[Mais sobre o Glitch.](https://help.glitch.com/hc/en-us)
