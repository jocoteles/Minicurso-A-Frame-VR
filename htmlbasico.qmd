...
- `style.css`: é o arquivo de estilos que altera a aparência, e à vezes a funcionalidade, dos elementos HTML.

E o arquivo `index.html` terá uma estrutura semelhante a esta:
...
## Disponibilizando páginas web diretamente na Internet
...
é possível navegar e inspecionar os arquivos (html, js, css) que o compõe e também fazer um *preview* da página web gerada a partir desses arquivos.
