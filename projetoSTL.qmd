...
![Sistema Sol-Terra-Lua com todos os movimentos -- de rotação e orbital -- implementados, visto de cima.](stl_animado.mp4){loop="true"}
...
![Sistema Sol-Terra-Lua com todos os movimentos e inclinações do eixo da Terra e da órbita da Lua, visto de perfil.](movimento-completo-com-inclinacoes.mp4){loop="true"}
...
![Imagem da renderização Sistema Sol-Terra-Lua do projeto completo incluindo os elementos gráficos de referência, visto de cima.](screenshot_projeto_completo.png){loop="true"}
